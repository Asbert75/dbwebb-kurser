...
#
# fc2b7a7ef834c0de0a4698ded92483a7
# linux
# bash1
# eroa16
# 2017-01-29 15:22:26
# v2.2.27 (2017-01-24)
#
# Generated 2017-01-29 16:22:27 by dbwebb lab-utility v2.2.27 (2017-01-24).
...
ANSWER=$(cd apache2/conf-available && ls -1Sr)
...
ANSWER=$(mkdir -p backup/ && mkdir -p backup/conf/ && cp apache2/mods-available/*.conf backup/conf/ && ls backup/conf/ -1S)

# I will now test your answer - change false to true to get a hint.
assertEqual "3.1" false "$ANSWER"
...
ANSWER=$(cp -r backup/php/. backup/ && rm -r backup/php && ls -1p backup/)
...
ANSWER=$(find -iname "apache2.conf" -printf "%P\n")

# I will now test your answer - change false to true to get a hint.
assertEqual "4.1" true "$ANSWER"
...
ANSWER=$(find apache2/ -maxdepth 1 -type d -iname "*conf*")
