...
function placeRandom(res) {
    // generate random coordinates
    var x = Math.floor(Math.random() * (gameBoard.getSize() - 0 + 1)) + 0;
    var y = Math.floor(Math.random() * (gameBoard.getSize() - 0 + 1)) + 0;
